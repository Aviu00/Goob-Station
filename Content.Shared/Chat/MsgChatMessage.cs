...
namespace Content.Shared.Chat
{
    ...
    public sealed class ChatMessage
    {
        ...
        public bool CanCoalesce; // Goob Edit

        [NonSerialized]
        public bool Read;

        public ChatMessage(ChatChannel channel, string message, string wrappedMessage, NetEntity source, int? senderKey, bool hideChat = false, Color? colorOverride = null, string? audioPath = null, float audioVolume = 0, bool canCoalesce = true) // Goob edit
        {
            Channel = channel;
            Message = message;
            ...
            CanCoalesce = canCoalesce; // Goob edit
        }
    }
